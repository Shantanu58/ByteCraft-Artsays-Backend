                    ...
                    <div class="email-container">
                        ...
                        <div class="header">
                            <div class="logo-container">
                                ${attachments.length > 0 ? `<img src="cid:artsays_logo" alt="Artsays Logo" class="logo">` : ''}
                            </div>
                            <h1 class="welcome-heading">New ${userType} Registration</h1>
                        </div>
                        ...
                        <div class="content">
                            ...
                            <p class="message">A new ${userType} has registered on Artsays and requires verification.</p>
                            
                            <!-- User Details Box -->
                            <div class="user-details-box">
                                <div class="detail-item">
                                    <span class="detail-label">Name: ${newUser.name} ${newUser.lastName}</span>
                                </div>
                                ${newUser.email ? `
                                <div class="detail-item">
                                    <span class="detail-label">Email: ${newUser.email}</span>
                                </div>` : ''}
                                ${newUser.phone ? `
                                <div class="detail-item">
                                    <span class="detail-label">Phone: ${newUser.phone}</span>
                                </div>` : ''}
                                <div class="detail-item">
                                    <span class="detail-label">User Type: ${userType}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Registered At: ${new Date().toLocaleString()}</span>
                                </div>
                            </div>
                            
                            <!-- Status Notice -->
                            <div class="status-notice">
                                <p class="status-title">Verification Required</p>
                                <p class="status-text">
                            ...
                            <div style="text-align: center;">
                                <a href="${adminDashboardLink}" class="action-button">Review in Admin Dashboard</a>
                            </div>
                        ...
                        <body>
                            <div class="email-container">
                                ...
                                <div class="header">
                                    ...
                                    <h1 class="welcome-heading">${userType} Management Portal</h1>
                                </div>
                                ...
                                <div class="content">
                                    ...
                                    <p class="message">Thank you for registering as a ${userType} on Artsays. We're excited to have you on board!</p>

                                        ${verificationNote}
                                    
                                    <p class="message">Your account has been successfully created. Here are your login credentials:</p>
                                    
                                    <!-- Credentials Box -->
                                    <div class="credentials-box">
                                        <div class="credential-item">
                                            <span class="credential-label">Email: ${email}</span>
                                        </div>
                                        <div class="credential-item">
                                            <span class="credential-label">Password: ${password}</span>
                                        </div>
                                        <div class="credential-item">
                                            <span class="credential-label">Account Type: ${userType}</span>
                                        </div>
                                    </div>
                                    
                                    <!-- Action Button -->
                                    <div style="text-align: center;">
                                        <a href="http://localhost:3000/login" class="action-button">Access Your Account</a>
                                    </div>
                                    
                                    <p class="message">For your security, we recommend changing your password after your first login.</p>
